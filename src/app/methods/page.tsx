...
const SOURCE_TABLE: Array<{
  ...
  { source: "EpiOnco v0 — Curated epifactors", what: "Epigenetic regulators (writers/erasers/readers/remodelers) for Tumour Ability Score", nodes_in_graph: "50 high-priority epifactors with cancer role + drug links + Hanahan-Weinberg hallmark mapping", full_size: "Full EpifactorDB ≈ 800 — ingestion via epifactordb.com on roadmap", status: "partial", license: "Open (EpifactorDB CC)" },
  { source: "EpiOnco v0 — Indian cancer epigenomes", what: "Documented Indian-specific epigenetic signatures distinct from TCGA", nodes_in_graph: "3 signatures (Indian OSCC PMID:17139279 · NE India HNC PMID:33033692 · Indian PDAC PMID:36059159)", full_size: "Indian Cancer Genome Atlas (ICGA) — partnership in progress", status: "partial", license: "Published (open access via PubMed)" },
  { source: "EpiOnco v0 — Epigenetic drugs", what: "Approved + clinical epigenetic therapeutics linked to epifactor targets", nodes_in_graph: "14 drugs (Tazemetostat, Azacitidine, Decitabine, Vorinostat, Romidepsin, etc.) with INHIBITS_EPIFACTOR edges", full_size: "Same — covers all FDA-approved epigenetic therapies as of 2024", status: "loaded", license: "Open" },
  { source: "TCGA methylation + RNA-seq", what: "33-cancer-type methylation (450K array) + RNA-seq for global reference", nodes_in_graph: "Not ingested — used as conceptual baseline only", full_size: "10,000+ samples; ~500GB methylation + 200GB RNA-seq via GDC API", status: "planned", license: "Open (NIH GDC)" },
];
